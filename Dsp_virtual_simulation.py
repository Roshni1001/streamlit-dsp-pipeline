...
with col_vid:
    st.markdown("### 📽️ Real Highway Traffic Video Feed")
    # Swapped the placeholder video URL with an open-source highway traffic stock video asset
    st.video("https://assets.mixkit.co/videos/preview/mixkit-traffic-on-a-highway-from-above-41712-large.mp4") 
    st.caption("ℹ️ Synchronized stream playing over a 10-second window to replicate the edge simulation.")
